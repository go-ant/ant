  ...
  (function(){
    ...
    function UtilFactory($document, $timeout, $compile, $rootScope, $$mdAnimate, $interpolate, $log, $rootElement, $window) {
      ...
      var $mdUtil = {
        ...
        /**
         * Functional equivalent for $element.filter(鈥榤d-bottom-sheet鈥�)
 ...
 * });
   ...
   *     $mdDateLocaleProvider.months = ['janvier', 'f茅vrier', 'mars', ...];
   *     $mdDateLocaleProvider.shortMonths = ['janv', 'f茅vr', 'mars', ...];
 ...
 * })(angular);
  ...
  (function(){
     ...
     *
     * For operations where the user is asked to wait a moment while something finishes up, and it鈥檚
  ...
  (function(){
     ...
     * something finishes up, and it鈥檚 not necessary to expose what's
